...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [5] = LAYOUT_voyager(
    ...
    QK_BOOT,        KC_NO,          KC_NO,          KC_NO,          KC_NO,          KC_NO,                                          MAC_LOCK,       KC_BRIGHTNESS_DOWN,KC_BRIGHTNESS_UP,KC_PSCR,        KC_NO,          KC_NO,          
